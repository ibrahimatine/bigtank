  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {showDropdown && suggestions.length > 0 && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-[var(--color-card)] text-[var(--color-card-foreground)] rounded-lg shadow-xl border border-[var(--color-border)] z-50 overflow-hidden">
